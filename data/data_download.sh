...
wget -c https://msmarco.blob.core.windows.net/msmarcoranking/collectionandqueries.tar.gz
tar -zxvf collectionandqueries.tar.gz
rm collectionandqueries.tar.gz

wget -c https://msmarco.blob.core.windows.net/msmarcoranking/msmarco-passagetest2019-top1000.tsv.gz
...
wget -c https://msmarco.blob.core.windows.net/msmarcoranking/msmarco-docs.tsv.gz
gunzip msmarco-docs.tsv.gz

wget -c https://msmarco.blob.core.windows.net/msmarcoranking/msmarco-doctrain-queries.tsv.gz
gunzip msmarco-doctrain-queries.tsv.gz

wget -c https://msmarco.blob.core.windows.net/msmarcoranking/msmarco-doctrain-qrels.tsv.gz
gunzip msmarco-doctrain-qrels.tsv.gz

wget -c https://msmarco.blob.core.windows.net/msmarcoranking/msmarco-test2019-queries.tsv.gz
gunzip msmarco-test2019-queries.tsv.gz

wget -c https://trec.nist.gov/data/deep/2019qrels-docs.txt

wget -c https://msmarco.blob.core.windows.net/msmarcoranking/msmarco-doctest2019-top100.gz
gunzip msmarco-doctest2019-top100.gz

wget -c https://msmarco.blob.core.windows.net/msmarcoranking/msmarco-docdev-top100.gz
gunzip msmarco-docdev-top100.gz

wget -c https://msmarco.blob.core.windows.net/msmarcoranking/msmarco-docdev-queries.tsv.gz
